    ...
    */
    private static checkForEquivalence<T>(
        ...
        if (valueA === valueB || (valueA === undefined && valueB === undefined) || (valueA === null && valueB === null)) {
            ...
            if (!Types.areSameTypes(valueA, valueB)) {
                return false;
            }

            if (!Types.isArray(valueA)) {
                const isNativeValueA = Types.isNative(valueA);
                const isNativeValueB = Types.isNative(valueB);
                if ((isNativeValueA && isNativeValueB)) {
                    ...
                    if (Types.isDate(valueA) && Types.isDate(valueB)) {
