...
import { Comparer, IEquivalenceComparisonOptions } from "../comparison/comparer";
import { Cloner } from "../cloning/cloner";
...
export class Snapshotter {
    ...
    private getObjectDefinedErrorMessage(value: Object): string {
        ...
        if (this.configuration.identificationKind === IdentificationKind.Id) {
     ...
     */
    public isChanged(value: Object, comparisonOptions?: IEquivalenceComparisonOptions): boolean {
        ...
        return !Comparer.areEquivalent(value, last, comparisonOptions);
    }
    ...
    private cloneTo<T>(source: T, target: Object): T {
        switch (this.configuration.snapshotKind) {
            case SnapshotKind.DeepClone:
                return Cloner.deepCloneTo(source, target);
            case SnapshotKind.ShallowClone:
                return Cloner.shallowCloneTo(source, target);
            default:
                throw new Error("unhandled snapshot kind");
        }
    }
    ...
    public save(value: Object): Snapshotter {
        ...
        if (Comparer.areEquivalent(value, history[0])) {
            return this;
        }
