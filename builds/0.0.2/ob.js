...
(function (Objs) {
    ...
    (function (Cloning) {
        var Cloner = (function () {
            ...
            Cloner.checkAndPrepareTargetForCloning = function (source, target) {
            ...
            Cloner.shallowCloneTo = function (source, target) {
                ...
                if (!Objs.Types.isArray(target)) {
                    ...
                    for (var index = 0; index < sourceArrayLength; ++index) {
                        targetArray[index] = this.shallowClone(sourceArray[index]);
                    }
                    return target;
                }
            };
            Cloner.deepCloneTo = function (source, target) {
                this.checkAndPrepareTargetForCloning(source, target);
                if (!Objs.Types.isArray(target)) {
...
(function (Objs) {
    ...
    (function (Snapshots) {
        ...
        var Snapshotter = (function () {
            ...
            Snapshotter.prototype.getObjectDefinedErrorMessage = function (value) {
            ...
            Snapshotter.prototype.ensureObjectDefinedOrThrow = function (value) {
                var error = this.getObjectDefinedErrorMessage(value);
                if (error) {
            ...
            Snapshotter.prototype.has = function (value) {
                var error = this.getObjectDefinedErrorMessage(value);
                if (error !== "") {
                    return false;
                }
            ...
            Snapshotter.prototype.count = function (value) {
                var error = this.getObjectDefinedErrorMessage(value);
                if (error !== "") {
                    return 0;
                }
            ...
            Snapshotter.prototype.cloneTo = function (source, target) {
                switch (this.configuration.snapshotKind) {
                    case SnapshotKind.DeepClone:
            ...
            Snapshotter.prototype.revert = function (value) {
                ...
                return this.cloneTo(history.shift(), value);
            };
            return Snapshotter;
        }());
